...
<body>
    ...
    <section id="activos-boton">
        <div class="container">
            <button class="boton-agregar" onclick="mostrarModalAgregar()"> AGREGAR UBICACION </button>
    ...
    <section id="tabla_activos">
        <div class="container">
            <table>
                ...
                <tbody id="tabla_body">
                    <?php include '03ConsultaUbicaciones.php'; ?>
                </tbody>
            </table>
        </div>
    </section>
    ...
    <div class="container">
        ...
        <ul>
            <li><strong>ID:</strong> Identificador único para cada ubicación en el sistema.</li>
            <li><strong>DESCRIPCION:</strong> Descripción de la ubicación, que puede incluir detalles como el nombre de la sala,<br> el área o el lugar específico donde se encuentra el activo.</li>
            <li><strong>EDIFICIO:</strong> Nombre o identificador del edificio donde se encuentra la ubicación.</li>
            <li><strong>PISO:</strong> Número o nombre del piso donde se encuentra la ubicación dentro del edificio.</li>
        </ul>
    </div>
    </section>
    <div id="modal-agregar" class="modal">
        <div class="modal-content">
            ...
            <?php include '03insertarUbicaciones.html'; ?>
        </div>
    </div>
    ...
    <div id="modal-eliminar" class="modal">
        <div class="modal-content">
            <span class="close" onclick="cerrarModal()">&times;</span>
            <?php include '03EliminarUbicaciones.html'; ?>
        </div>
    </div> 
    ...
    <div id="modal-buscar" class="modal">
        <div class="modal-content">
            <span class="close" onclick="cerrarModal()">&times;</span>
            <?php include '03BuscarUbicaciones.html'; ?>
        </div>
    </div>
    ...
    <script>
        ...
        function paginar(siguiente) {
            ...
            fetch('03ConsultaUbicaciones.php?pagina=' + paginaActual)
