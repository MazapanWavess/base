...
$totalResult = mysqli_query($conexion, "SELECT COUNT(*) as total FROM personas");
...
$result = mysqli_query($conexion, "SELECT * FROM personas LIMIT $resultadosPorPagina OFFSET $offset");
