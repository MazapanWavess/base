...
<body>
    ...
    <section id="tabla_activos">
        <div class="container">
            <table>
                ...
                <tbody id="tabla_body">
                    <?php include '01consultaactivos.php'; ?>
                </tbody>
            </table>
        </div>
    </section>
    ...
    <div class="container">
        ...
        <ul>
            <li><strong>ID:</strong> Identificador único para cada activo en el inventario.</li>
            <li><strong>DESCRIPCION:</strong> Descripción del activo, que puede incluir detalles como nombre, tipo, o características específicas.</li>
            <li><strong>TIPO:</strong> Tipo de activo, que puede ser por ejemplo material didáctico, equipo deportivo, mobiliario, etc.</li>
            <li><strong>MARCA:</strong> Marca del activo.</li>
            <li><strong>SERIE:</strong> Número de serie del activo, si aplica.</li>
            <li><strong>FECHA DE ADQUISICION:</strong> Fecha en la que el activo fue adquirido.</li>
            <li><strong>COSTO:</strong> Costo de adquisición del activo.</li>
            <li><strong>ESTADO ACTUAL:</strong> Estado actual del activo, como nuevo, usado, reparación, etc.</li>
            <li><strong>ID UBICACION:</strong> Identificador de la ubicación actual del activo en la escuela.</li>
            <li><strong>ID PERSONA:</strong> Identificador de la persona responsable del activo, si aplica.</li>
        </ul>
    </div>
    </section>
    ...
    <div id="modal-agregar" class="modal">
        <div class="modal-content">
            ...
            <?php include '01insertaractivos.html'; ?>
        </div>
    </div>
    ...
    <div id="modal-eliminar" class="modal">
        <div class="modal-content">
            <span class="close" onclick="cerrarModal()">&times;</span>
            <?php include '01EliminarActivos.html'; ?>
        </div>
    </div>
    ...
    <div id="modal-buscar" class="modal">
        <div class="modal-content">
            <span class="close" onclick="cerrarModal()">&times;</span>
            <?php include '01BuscarActivos.html'; ?>
        </div>
    </div>
    ...
    <script>
        ...
        function paginar(siguiente) {
            ...
            fetch('01consultaactivos.php?pagina=' + paginaActual)
